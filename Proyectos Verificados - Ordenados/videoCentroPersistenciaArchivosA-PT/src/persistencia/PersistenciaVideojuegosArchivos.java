/*
* PersistenciaVideojuegosArchivos.java
*
...
/**
 * Clase superior que invoca los diversos metodos de los paquetes daos .
 * Alumno;José Jesús Orozco Hernández ID:00000229141
 *
 * @author José Jesús Orozco Hernández
 */
public class PersistenciaVideojuegosArchivos implements IPersistenciaVideojuegos {
     ...
     */
    public PersistenciaVideojuegosArchivos() {
        this.catalogoVideojuegos = new Videojuegos(".\\videojuegos.dat");
        this.inventarioVideojuegos = new InventarioVideojuegos(".\\inventarioVideojuegos.dat");
    }
